        ...
        <main class="main-content">
            ...
            <div class="main-content-wrapper">
                <div class="main-content-wrapper-form">
                    ...
                    <form class="main-content-wrapper-form-form" action="forgotpassword" method="post">
                        <h5>DONT WORRY, HAPPENS TO THE BEST OF US</h5>
                        <h1>Forgot password ?</h1>
                    
                        <label for="email-address">Email address</label>
                        <input id="email-address" type="text" name="forgotemail" id="login" placeholder="exemple@email.com"
                        ...
                        <?php
                                ...
                                else if (isset($succes) && $succes != null)
                                    echo "<p class='error' style='color: lightgreen;'>" . $succes . "</p>";

                        ?>

                        <div>
                            <button type="submit" name="forgot" value="forgot">RESET</button>
                        </div>
